...
public class ShopExpenses extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShopExpenses frame = new ShopExpenses();
	...
	public ShopExpenses() {
		...
		JLabel lblBooks = new JLabel(" Collection:");
		...
		JLabel lblBags = new JLabel(" Disbursment:");
		...
		JLabel lblUniform = new JLabel(" Available Cash:");
		...
		lblUniform.setBounds(0, 0, 195, 34);
